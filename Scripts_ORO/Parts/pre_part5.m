% this function aims to show graphs that may be of interest to give a
% context to the developed part5 functions, in particular to the
...
xlabel('\DeltaV_{h_2} [m/s]');
ylabel('\DeltaV_{h_1} [m/s]');
